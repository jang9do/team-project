		...
		<div id="content">
			...
			<c:if test="${not empty pagingListAll }">
					<c:if test="${pagingListAll.startPage > pagingListAll.blockSize }">
						<a href="${conPath }/bunListAll.do?pageNum=${pagingListAll.startPage-1}">&lt;</a>
					</c:if>
			...
			<c:if test="${not empty pagingListIng }">
					<c:if test="${pagingListIng.startPage > pagingListIng.blockSize }">
						<a href="${conPath }/bboardListIng.do?pageNum=${pagingListIng.startPage-1}">&lt;</a>
					</c:if>
					...
					<c:if test="${pagingListIng.endPage < pagingListIng.pageCnt }">
						<a
							href="${conPath }/bboardListIng.do?pageNum=${pagingListIng.startPage+1}">></a>
					</c:if>
			</c:if>
			...
			<c:if test="${not empty pagingListPopular }">
					...
					<c:if
						...
						<a href="${conPath }/bboardListPopular.do?pageNum=${pagingListPopular.startPage-1}">&lt;</a>
					</c:if>
