		...
		<div id="fakeDiv"></div>
			...
			<div class="fakeDiv"></div>
				<ul class="msg_rightside">
					<li><input type="checkbox" id="allCheck" onclick="allChk(this)"></li>
				...
				<!-- 쪽지list -->
				<div class="msglist">
						<c:forEach var="mes" items="${msgSpList }">
							<!-- 쪽지 1개 둘러싸는 div -->
							<div class="mes_area">
					...
					<div id="paging">
						<c:if test="${paging.startPage>paging.blockSize }">
							<a href="${conPath }/msgSpList.do?pageNum=${paging.startPage-1 }&mesFrom=${param.mesFrom}">&lt;<</a>
						</c:if>
						<c:forEach var="i" begin="${paging.startPage }"
							...
							<c:if test="${i!=paging.currentPage }">
								<a href="${conPath }/msgSpList.do?pageNum=${i}&mesFrom=${param.mesFrom}">${i}</a>
							</c:if>
						</c:forEach>
						<c:if test="${paging.endPage<paging.pageCnt }">
							<a href="${conPath }/msgSpList.do?pageNum=${paging.endPage+1}&mesFrom=${param.mesFrom}">></a>
						</c:if>
					</div>
				</div>
		</div>
